...
export default class SummaryReportService {
  ...
  calculateSummary = (dailyReports: DailyReport[]): SummaryReport[] => {
    const summaryReports = new Array<SummaryReport>()
  ...
  mergeSummaryReport = (
    ...
    let ymdFrom = new DateHelper().subtractDay(dateRange).ymd()

    let mapSummary = new Map<string, SummaryReport>()
    ...
    const results = new Array<SummaryReport>()
